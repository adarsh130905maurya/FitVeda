        ...
        return http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((req, res, e) -> {
                            ...
                            res.getWriter().write("{\"error\":\"Unauthorized: Authentication token is missing or invalid\",\"status\":401}");
                        })
                        .accessDeniedHandler((req, res, e) -> {
                            res.setStatus(403);
                            res.setContentType("application/json");
                            res.getWriter().write("{\"error\":\"Forbidden: Access denied for this role\",\"status\":403}");
                        })
                )
